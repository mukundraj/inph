#Integrative analysis - Cluster assessment
...
p=.myDotPlotArrangerFn(inputGene="Gfap",inputPd=pd,inputExpData=data_grouped$data,cluster_col="anno_cluster_res")
p
...
p=.my2dPlotArrangerFn(inputPd=pd,inputGene="Gfap",inputExpData=data_seurat$data,argList=.ArgList,ncores=10,FeaturePlotOnly=F)
p
ggsave(plot=p,file="~/myBucket/torm3.pdf",height=20,width=20)
